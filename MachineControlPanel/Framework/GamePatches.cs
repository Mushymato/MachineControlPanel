    ...
    internal static class GamePatches
    {
        ...
        internal static void Apply(Harmony harmony)
        {
            try
            {
                ...
                ModEntry.Log(
                    $"Applied MachineDataUtility.CanApplyOutput Transpiler",
                    LogLevel.Trace
                );
                harmony.Patch(
                ...
                ModEntry.Log(
                    $"Applied MachineDataUtility.PlaceInMachine Transpiler",
                    LogLevel.Trace
                );
            }
            catch (Exception err)
        ...
        )
        {
            try
            {
                ...
                matcher
                    ...
                    .ThrowIfNotMatch(
                        "Failed to find 'if (trigger2.RequiredCount > inputItem.Stack)'"
                    );
                ...
                matcher.Insert(
                    [
                        ...
                        new(
                            ...
                            AccessTools.Method(
                                typeof(GamePatches),
                                nameof(ShowSkippedReasonMessage)
                            )
                        ),
                    ]
                );
