...
### Added
- Add the ability to search machines by input items, this can be slow on large mod lists.
- Improve performance for custom method probing at expense of some accuracy
- Perfection handbook reminders integration
...
### Added
- You can now scroll continuously across paginated rules.
- Switched to [StardewUI Continued](https://github.com/Mushymato/StardewUI) for the following features:
    - Built-in Lookup Anything
...
### Added
- Config to enable/disable per-save machine panel configs. Enabled is the previous behavior.
